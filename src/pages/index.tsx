...
export default function Home() {
    return (
        <Container>
            ...
            <Feature src="covidexposures/out/assets/subscriptions.png" height={624/2} width={1504/2} href="/login">
            ...
            <Feature src="covidexposures/out/assets/heatmap-high.png" height={1574/4} width={1996/4} text="LEFT" href="/heatmap">
                <p>
